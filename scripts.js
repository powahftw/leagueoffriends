...
function genUI(arr) {
    ...
    for (var i in arr) {
        ...
        var servername = String(arr[i].number).toUpperCase().replace(1, "") + " " + String(arr[i].name)
...
$(document).ready(function() {
    ...
    $('button').click(function() {
        ...
        var inputname = $("input[name=task]").val().replace(" ","");
        ...
        if (0 < inputname.length &&     // Not null string
            ...
            var newEntry = {
                ...
                name: inputname.replace(" ", "").toLowerCase().replace(" ",""),
                status: "notingame",
                toupdate: true,
            }
            arr.push(newEntry);
    ...
    $("body").on('click', '#todo a', function() {
        ...
        for (var i in arr) { // Find index of the element to remove
            ...
            if (string[0] == arr[i].number.toUpperCase().replace(1, "") && string[1] === arr[i].name)
                todelete = i
        }
